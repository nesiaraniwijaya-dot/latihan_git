...
// --- PERBAIKAN DI SINI ---
// Mengambil HANYA riwayat cuti KHL milik karyawan ini
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="active"><a href="riwayat_cuti_khl.php"><i class="fas fa-list-alt"></i> Riwayat Cuti KHL</a></li>
                </ul>
            </nav>
        </aside>
        <main class="main-content">
            <header class="main-header">
                <div class="welcome-message">
                    <h2>Riwayat Pengajuan Cuti KHL Anda</h2>
                    <p>Berikut adalah semua pengajuan Cuti KHL yang pernah Anda buat.</p>
                </div>
                    ...
                    <tbody>
                        <?php if ($result_riwayat->num_rows > 0): while($row = $result_riwayat->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="status-badge-ajuan <?php echo strtolower(str_replace(' ', '-', $row['status_pengajuan'])); ?>">
                        ...
                        <?php endwhile; else: ?>
                            <tr>
                                <td colspan="5">Anda belum pernah mengajukan Cuti KHL.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
