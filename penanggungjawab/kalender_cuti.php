...
<html lang="id">
<head>
    <meta charset="UTF-8"><title>Kalender Cuti</title>
       ...
       <aside class="sidebar">
        ...
        <main class="main-content">
            <header class="main-header">
                <div class="header-left"><h1 class="title">Kalender Cuti Divisi</h1><p class="subtitle">Divisi <?php echo htmlspecialchars($divisi_pj); ?></p></div>
            </header>
