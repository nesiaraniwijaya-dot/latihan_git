...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($tanggal_pengajuan_dt->diff($tanggal_khl_dt)->days > 30) {
        ...
        // --- PERBAIKAN LOGIKA INSERT DI SINI ---
...
<head>
    <meta charset="UTF-8">
    <title>Pengajuan Cuti KHL Pribadi</title>
    ...
    <div class="dashboard-wrapper">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li class="active"><a href="persetujuan_cuti_khl.php"><i class="fas fa-check-square"></i> Ajukan Cuti KHL</a></li>
        ...
        <main class="main-content">
            ...
            <section class="content-form card">
                ...
                <form action="persetujuan_cuti_khl.php" method="POST">
